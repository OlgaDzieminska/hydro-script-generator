...
NO_DATA_FOR_PROVIDED_CITY_AND_RIVER_MESSAGE = 'Nie można znaleźć danych dla podanej rzeki w podanym przekroju. Rok: %d'
WATER_PARAMETERS = ['h_water', 'Q']
